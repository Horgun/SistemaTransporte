...
//        SessionBean session = (SessionBean) wrappedRequest.getSession().getAttribute("sessionBean");
        
        try {
            if (session == null || !session.isLoggedIn()){
                String contextPath = wrappedRequest.getContextPath();
                wrappedResponse.sendRedirect(contextPath + "/login.xhtml");
            }
            else{
